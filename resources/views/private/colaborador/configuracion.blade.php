...
<script>
    ...
    function saveProfile() {
        ...
        fetch('{{ route("colaborador.configuracion.update-profile") }}', {
            method: 'POST',
            headers: {
    ...
    fetch('{{ route("colaborador.configuracion.upload-photo") }}', {
        method: 'POST',
        body: formData
    })
    .then(response => {
...
function saveSecurity() {
    ...
    fetch('{{ route("colaborador.configuracion.update-security") }}', {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        },
