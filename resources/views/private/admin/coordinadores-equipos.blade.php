...
<div class="space-y-6 p-4">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600">Gestiona los coordinadores de equipo de la empresa <strong>{{ $empresa->nombre }}</strong>.</p>
        </div>
    </div>
    ...
    {{-- Table --}}
    @include('partials.admin.tablas.pag.coord-equipos-tabla-pag')
