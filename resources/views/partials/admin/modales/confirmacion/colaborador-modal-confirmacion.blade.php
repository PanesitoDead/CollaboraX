...
<script>
  let colaboradorCambioId = null;

  function abrirModalConfirmacion(id, activo) {
    colaboradorCambioId = id;
    ...
    form.action = `/admin/colaboradores/${id}/cambiar-estado`;
  ...
  document.addEventListener('keydown', (e) => {
    if (e.key === 'Escape' && colaboradorCambioId !== null) {
